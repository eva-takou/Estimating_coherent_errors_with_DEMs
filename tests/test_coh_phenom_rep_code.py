#Test the coherent phenomenological noise model for the repetition code memory. 
#We truncate the estimation to edges.
...
def estimate_coh_DEM(detection_events,d,rds):
...
def verify_coh_model(ITERS):
    ...
    for d in ds:
        ...
        for theta in thetas:
            ...
            DEM = estimate_coh_DEM(detection_events,d,rds)
