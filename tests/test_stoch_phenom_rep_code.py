#Test the phenomenological noise model where data qubits and ancilla qubits
#experience single qubit depolarizing per round. Expected threshold is ~15.5% as simulated with stim as well.
